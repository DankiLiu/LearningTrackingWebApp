"""
Django settings for mycrochet project.
...
SECRET_KEY = 'django-insecure-y^4wylz8knnl+bf02(-osiq5&ut0gh^jy_y7-=)mor=ateb0jy'
...
WSGI_APPLICATION = 'mycrochet.wsgi.application'
